...
using static Saving.Utilities.ConsoleColors;

namespace Saving.Utilities
{
    /// <summary>
    ...
    public static class ConsoleKeysHelper
    {
        ...
        public static string ReadLineFiveSeconds(string message = "") 
            => ReadLineWithTimeout(5, message);
        ...
        /// <param name="message">Message to display (optional)</param>
        /// <returns>user input or empty string</returns>
        public static string PauseFiveSeconds(string message = "") 
            => ReadLineWithTimeout(5, message);
        ...
        /// <param name="message">Message to display (optional)</param>
        /// <returns>user input or empty string</returns>
        public static string ReadLineTenSeconds(string message = "") 
            => ReadLineWithTimeout(10, message);
        ...
        /// <param name="message">Message to display (optional)</param>
        /// <returns>user input or empty string</returns>
        public static string PauseTenSeconds(string message = "") 
            => ReadLineWithTimeout(10, message);
    }
}
